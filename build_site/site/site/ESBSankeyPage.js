...
var svg, tooltip, sankey, path, defs, colorScale, highlightColorScale, isTransitioning;
...
var OPACITY = {
    ...
    TYPES = ["system","receive", "send", "transform"],
    TYPE_COLORS = ["#424E59","#9ABF4B", "#F2E20F", "#BF9004"],
    TYPE_HIGHLIGHT_COLORS = ["#e5c494","#66c2a5", "#fc8d62", "#8da0cb"],
    LINK_COLOR = "#b3b3b3",
    INFLOW_COLOR = "#2E86D1",
...
var formatNumber = function (d) {
        ...
        return numberFormat(d) + " AMPD";
    },

    formatFlow = function (d) {
        var flowFormat = d3.format(",.0f"); // zero decimal places with sign
        return flowFormat(Math.abs(d)) + " AMPD";
    },
...
path = sankey.link().curvature(0.45);
...
//acquire and format systems data from API

d3.json("http://104.196.107.109:24890/api/systems", function(systems) {
    sankey
        .initialize(systems, function (node) {
